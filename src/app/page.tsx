...
export default function LandingPage() {
  ...
  return (
    <main className="landing-page min-h-screen overflow-hidden bg-[#071018] text-[#f4f7f5]">
      ...
      <section className="landing-grid relative isolate px-5 pb-20 pt-36 sm:px-8 sm:pt-44 lg:pb-28">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.02fr_0.98fr] lg:gap-12">
          <div className="landing-hero-content max-w-2xl">
            <div className="landing-delay-1 mb-6 inline-flex items-center gap-2 rounded-full border border-[#d5f56f]/25 bg-[#d5f56f]/10 px-3 py-1.5 text-xs font-medium text-[#d5f56f]"><Sparkles className="h-3.5 w-3.5" /> {t('aiCivicGuidance')}</div>
            ...
            <div className="landing-delay-4 mt-9 flex flex-wrap items-center gap-x-6 gap-y-3 text-xs text-[#7e8d8a]"><span className="flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-[#d5f56f]" /> {t('privateByDesign')}</span><span className="flex items-center gap-2"><Globe2 className="h-4 w-4 text-[#d5f56f]" /> {t('builtForIndia')}</span></div>
          </div>

          <div className="landing-visual relative mx-auto w-full max-w-[560px] lg:ml-auto"><div className="landing-orbit landing-orbit-one" /><div className="landing-orbit landing-orbit-two" /><div className="relative rounded-2xl border border-white/15 bg-[#0d1b24]/90 p-4 shadow-[0_24px_100px_rgba(0,0,0,0.35)] backdrop-blur sm:p-6"><div className="mb-5 flex items-center justify-between border-b border-white/10 pb-4"><div className="flex items-center gap-2 text-xs text-[#91a09c]"><span className="h-2 w-2 rounded-full bg-[#d5f56f]" /> {t('workspace')}</div><span className="rounded-full bg-[#d5f56f]/10 px-2 py-1 text-[10px] text-[#d5f56f]">{t('liveAnalysis')}</span></div><div className="grid gap-3 sm:grid-cols-[1fr_0.88fr]"><div className="rounded-xl border border-white/10 bg-[#12232d] p-4"><div className="mb-7 flex items-center justify-between"><FileText className="h-5 w-5 text-[#d5f56f]" /><span className="text-[10px] text-[#6f807b]">{t('pdfPages')}</span></div><div className="space-y-2.5"><div className="h-2 w-3/4 rounded-full bg-white/20" /><div className="h-2 w-full rounded-full bg-white/10" /><div className="h-2 w-5/6 rounded-full bg-white/10" /><div className="mt-5 h-16 rounded-lg border border-[#d5f56f]/20 bg-[#d5f56f]/5" /></div><div className="mt-6 flex items-center gap-2 text-xs text-[#aebbb8]"><BadgeCheck className="h-4 w-4 text-[#d5f56f]" /> {t('publicServiceNotice')}</div></div><div className="flex flex-col gap-3"><div className="landing-float-card rounded-xl border border-[#d5f56f]/30 bg-[#d5f56f]/10 p-4"><div className="mb-3 flex items-center gap-2 text-xs font-medium text-[#d5f56f]"><Sparkles className="h-4 w-4" /> {t('aiAnalysis')}</div><p className="text-sm leading-6 text-[#e0e9d8]">{t('keyDeadline')}</p></div><div className="landing-float-card landing-float-card-delay rounded-xl border border-white/10 bg-[#12232d] p-4"><div className="mb-3 flex items-center gap-2 text-xs font-medium text-[#cbd6d3]"><ListChecks className="h-4 w-4 text-[#d5f56f]" /> {t('evidence')}</div><div className="space-y-2 text-xs text-[#91a09c]"><div className="flex items-center gap-2"><Check className="h-3.5 w-3.5 text-[#d5f56f]" /> {t('identityProof')}</div><div className="flex items-center gap-2"><CircleDot className="h-3.5 w-3.5 text-[#f4bf70]" /> {t('addressProofNeeded')}</div></div></div><div className="rounded-xl border border-white/10 bg-[#12232d] p-4"><div className="mb-3 flex items-center gap-2 text-xs font-medium text-[#cbd6d3]"><ArrowRight className="h-4 w-4 text-[#d5f56f]" /> {t('recommendation')}</div><p className="text-sm text-white">{t('submitEvidence')}</p></div></div></div><div className="mt-5 flex items-center gap-3 border-t border-white/10 pt-4 text-xs text-[#7e8d8a]"><div className="h-1.5 flex-1 overflow-hidden rounded-full bg-white/10"><div className="h-full w-4/5 rounded-full bg-[#d5f56f]" /></div><span>{t('analysisPercent')}</span></div></div></div>
        </div>
      </section>

      <section id="about" className="border-y border-white/10 bg-[#0a1720] px-5 py-10 sm:px-8" data-reveal><div className={`mx-auto grid max-w-7xl gap-6 md:grid-cols-[1fr_2fr] md:items-center ${reveal('about')}`}><p className="max-w-xs text-sm font-medium uppercase tracking-[0.16em] text-[#71817d]">{t('builtToMakeCivic')}</p><div className="grid gap-4 sm:grid-cols-3"><div className="landing-trust-item"><BadgeCheck className="h-5 w-5 text-[#d5f56f]" /><span>{t('clear')}</span></div><div className="landing-trust-item"><ShieldCheck className="h-5 w-5 text-[#d5f56f]" /><span>{t('evidenceBased')}</span></div><div className="landing-trust-item"><ArrowRight className="h-5 w-5 text-[#d5f56f]" /><span>{t('actionOriented')}</span></div></div></div></section>
      ...
      <footer className="border-t border-white/10 bg-[#050c12] px-5 py-12 sm:px-8"><div className="mx-auto max-w-7xl"><div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr]"><div><Brand inverted /><p className="mt-5 max-w-xs text-sm leading-6 text-[#71817d]">{t('brandDescription')}</p></div><div><h3 className="text-xs font-semibold uppercase tracking-[0.16em] text-[#71817d]">{t('product')}</h3><div className="mt-4 space-y-3 text-sm text-[#aebbb8]"><a href="#features" className="block hover:text-[#d5f56f]">{t('navFeatures')}</a><a href="#how-it-works" className="block hover:text-[#d5f56f]">{t('navHowItWorks')}</a></div></div><div><h3 className="text-xs font-semibold uppercase tracking-[0.16em] text-[#71817d]">{t('support')}</h3><div className="mt-4 space-y-3 text-sm text-[#aebbb8]"><Link href="/help" className="block hover:text-[#d5f56f]">{t('help')}</Link><Link href="/login" className="block hover:text-[#d5f56f]">{t('login')}</Link><Link href="/help" className="block hover:text-[#d5f56f]">{t('contactSupport')}</Link></div></div><div><h3 className="text-xs font-semibold uppercase tracking-[0.16em] text-[#71817d]">{t('legal')}</h3><div className="mt-4 space-y-3 text-sm text-[#aebbb8]"><Link href="/privacy-policy" className="block hover:text-[#d5f56f]">{t('privacyPolicy')}</Link><Link href="/terms" className="block hover:text-[#d5f56f]">{t('termsOfService')}</Link></div></div></div><div className="mt-12 border-t border-white/10 pt-6 text-xs text-[#61716d]">© 2026 NayaSathi. {t('builtForClearerAction')}</div></div></footer>
    </main>
  );
}
