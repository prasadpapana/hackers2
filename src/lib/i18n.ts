...
const benefitTranslations: Partial<Record<SupportedLanguage, Record<string, string>>> = {
  en: { benefitSimple: 'Simple explanations', benefitSimpleDescription: 'Plain language for complex civic information.', benefitMultilingual: 'Multilingual support', benefitMultilingualDescription: 'Built for people across India.', benefitEvidence: 'Evidence-based guidance', benefitEvidenceDescription: 'Grounded in the details of your documents.', benefitCaseTracking: 'Case tracking', benefitCaseTrackingDescription: 'Keep documents, actions and progress together.', benefitTimeline: 'Timeline visualization', benefitTimelineDescription: 'See what happened and what comes next.', benefitActionPlans: 'Action plans', benefitActionPlansDescription: 'Move from uncertainty to a clear next step.' },
  te: { benefitSimple: 'సరళమైన వివరణలు', benefitSimpleDescription: 'సంక్లిష్ట పౌర సమాచారాన్ని సులభమైన భాషలో అర్థం చేసుకోండి.', benefitMultilingual: 'బహుభాషా మద్దతు', benefitMultilingualDescription: 'భారతదేశంలోని ప్రజల కోసం నిర్మించబడింది.', benefitEvidence: 'ఆధార ఆధారిత మార్గదర్శకం', benefitEvidenceDescription: 'మీ పత్రాల వివరాల ఆధారంగా.', benefitCaseTracking: 'కేసు ట్రాకింగ్', benefitCaseTrackingDescription: 'పత్రాలు, చర్యలు మరియు పురోగతిని ఒకచోట ఉంచండి.', benefitTimeline: 'టైమ్‌లైన్ వీక్షణ', benefitTimelineDescription: 'ఏం జరిగిందో, తర్వాత ఏం జరుగుతుందో చూడండి.', benefitActionPlans: 'చర్య ప్రణాళికలు', benefitActionPlansDescription: 'అనిశ్చితి నుంచి స్పష్టమైన తదుపరి అడుగుకు వెళ్లండి.' },
  hi: { benefitSimple: 'सरल व्याख्याएं', benefitSimpleDescription: 'जटिल नागरिक जानकारी को सरल भाषा में समझें।', benefitMultilingual: 'बहुभाषी सहायता', benefitMultilingualDescription: 'भारत के लोगों के लिए बनाया गया।', benefitEvidence: 'सबूत-आधारित मार्गदर्शन', benefitEvidenceDescription: 'आपके दस्तावेज़ों के विवरण पर आधारित।', benefitCaseTracking: 'मामला ट्रैकिंग', benefitCaseTrackingDescription: 'दस्तावेज़, कार्रवाई और प्रगति एक जगह रखें।', benefitTimeline: 'समयरेखा दृश्य', benefitTimelineDescription: 'देखें क्या हुआ और आगे क्या होगा।', benefitActionPlans: 'कार्य योजनाएं', benefitActionPlansDescription: 'अनिश्चितता से स्पष्ट अगले कदम तक पहुंचें।' },
  ta: { benefitSimple: 'எளிய விளக்கங்கள்', benefitSimpleDescription: 'சிக்கலான குடிமைத் தகவல்களை எளிய மொழியில் புரிந்துகொள்ளுங்கள்.', benefitMultilingual: 'பலமொழி ஆதரவு', benefitMultilingualDescription: 'இந்திய மக்களுக்காக உருவாக்கப்பட்டது.', benefitEvidence: 'ஆதார அடிப்படையிலான வழிகாட்டல்', benefitEvidenceDescription: 'உங்கள் ஆவணங்களின் விவரங்களை அடிப்படையாகக் கொண்டது.', benefitCaseTracking: 'வழக்கு கண்காணிப்பு', benefitCaseTrackingDescription: 'ஆவணங்கள், செயல்கள் மற்றும் முன்னேற்றத்தை ஒரே இடத்தில் வைத்திருங்கள்.', benefitTimeline: 'காலவரிசை காட்சி', benefitTimelineDescription: 'என்ன நடந்தது, அடுத்து என்ன என்பதைப் பாருங்கள்.', benefitActionPlans: 'செயல் திட்டங்கள்', benefitActionPlansDescription: 'நிச்சயமின்மையிலிருந்து தெளிவான அடுத்த படிக்கு செல்லுங்கள்.' },
  kn: { benefitSimple: 'ಸರಳ ವಿವರಣೆಗಳು', benefitSimpleDescription: 'ಸಂಕೀರ್ಣ ನಾಗರಿಕ ಮಾಹಿತಿಯನ್ನು ಸರಳ ಭಾಷೆಯಲ್ಲಿ ಅರ್ಥಮಾಡಿಕೊಳ್ಳಿ.', benefitMultilingual: 'ಬಹುಭಾಷಾ ಬೆಂಬಲ', benefitMultilingualDescription: 'ಭಾರತದ ಜನರಿಗಾಗಿ ನಿರ್ಮಿಸಲಾಗಿದೆ.', benefitEvidence: 'ಪುರಾವೆ ಆಧಾರಿತ ಮಾರ್ಗದರ್ಶನ', benefitEvidenceDescription: 'ನಿಮ್ಮ ದಾಖಲೆಗಳ ವಿವರಗಳನ್ನು ಆಧರಿಸಿದೆ.', benefitCaseTracking: 'ಪ್ರಕರಣ ಟ್ರ್ಯಾಕಿಂಗ್', benefitCaseTrackingDescription: 'ದಾಖಲೆಗಳು, ಕ್ರಮಗಳು ಮತ್ತು ಪ್ರಗತಿಯನ್ನು ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ ಇರಿಸಿ.', benefitTimeline: 'ಸಮಯರೇಖೆ ವೀಕ್ಷಣೆ', benefitTimelineDescription: 'ಏನಾಯಿತು ಮತ್ತು ಮುಂದೆ ಏನು ಎಂಬುದನ್ನು ನೋಡಿ.', benefitActionPlans: 'ಕ್ರಿಯಾ ಯೋಜನೆಗಳು', benefitActionPlansDescription: 'ಅನಿಶ್ಚಿತತೆಯಿಂದ ಸ್ಪಷ್ಟ ಮುಂದಿನ ಹೆಜ್ಜೆಗೆ ಸಾಗಿರಿ.' },
  ml: { benefitSimple: 'ലളിതമായ വിശദീകരണങ്ങൾ', benefitSimpleDescription: 'സങ്കീർണ്ണമായ പൗര വിവരങ്ങൾ ലളിതമായ ഭാഷയിൽ മനസ്സിലാക്കുക.', benefitMultilingual: 'ബഹുഭാഷാ പിന്തുണ', benefitMultilingualDescription: 'ഇന്ത്യയിലെ ജനങ്ങൾക്കായി നിർമ്മിച്ചത്.', benefitEvidence: 'തെളിവ് അടിസ്ഥാനമാക്കിയ മാർഗനിർദേശം', benefitEvidenceDescription: 'നിങ്ങളുടെ രേഖകളിലെ വിശദാംശങ്ങളെ അടിസ്ഥാനമാക്കി.', benefitCaseTracking: 'കേസ് ട്രാക്കിംഗ്', benefitCaseTrackingDescription: 'രേഖകളും പ്രവർത്തനങ്ങളും പുരോഗതിയും ഒരിടത്ത് സൂക്ഷിക്കുക.', benefitTimeline: 'ടൈംലൈൻ കാഴ്ച', benefitTimelineDescription: 'എന്ത് സംഭവിച്ചു, ഇനി എന്ത് എന്നത് കാണുക.', benefitActionPlans: 'പ്രവർത്തന പദ്ധതികൾ', benefitActionPlansDescription: 'അനിശ്ചിതത്വത്തിൽ നിന്ന് വ്യക്തമായ അടുത്ത ഘട്ടത്തിലേക്ക് നീങ്ങുക.' },
  mr: { benefitSimple: 'सोपे स्पष्टीकरण', benefitSimpleDescription: 'क्लिष्ट नागरी माहिती सोप्या भाषेत समजून घ्या.', benefitMultilingual: 'बहुभाषिक मदत', benefitMultilingualDescription: 'भारतातील लोकांसाठी तयार केलेले.', benefitEvidence: 'पुराव्यावर आधारित मार्गदर्शन', benefitEvidenceDescription: 'तुमच्या कागदपत्रांच्या तपशीलावर आधारित.', benefitCaseTracking: 'प्रकरणाचा मागोवा', benefitCaseTrackingDescription: 'कागदपत्रे, कृती आणि प्रगती एकत्र ठेवा.', benefitTimeline: 'समयरेषा दृश्य', benefitTimelineDescription: 'काय झाले आणि पुढे काय होईल ते पहा.', benefitActionPlans: 'कृती योजना', benefitActionPlansDescription: 'अनिश्चिततेतून स्पष्ट पुढील पावलाकडे जा.' },
  bn: { benefitSimple: 'সহজ ব্যাখ্যা', benefitSimpleDescription: 'জটিল নাগরিক তথ্য সহজ ভাষায় বুঝুন।', benefitMultilingual: 'বহুভাষিক সহায়তা', benefitMultilingualDescription: 'ভারতের মানুষের জন্য তৈরি।', benefitEvidence: 'প্রমাণভিত্তিক নির্দেশনা', benefitEvidenceDescription: 'আপনার নথির বিবরণের ওপর ভিত্তি করে।', benefitCaseTracking: 'মামলা ট্র্যাকিং', benefitCaseTrackingDescription: 'নথি, পদক্ষেপ ও অগ্রগতি এক জায়গায় রাখুন।', benefitTimeline: 'সময়রেখা দৃশ্য', benefitTimelineDescription: 'কী ঘটেছে এবং এরপর কী হবে দেখুন।', benefitActionPlans: 'কর্মপরিকল্পনা', benefitActionPlansDescription: 'অনিশ্চয়তা থেকে স্পষ্ট পরবর্তী পদক্ষেপে এগিয়ে যান।' },
  gu: { benefitSimple: 'સરળ સમજૂતી', benefitSimpleDescription: 'જટિલ નાગરિક માહિતીને સરળ ભાષામાં સમજો.', benefitMultilingual: 'બહુભાષી સહાય', benefitMultilingualDescription: 'ભારતના લોકો માટે બનાવવામાં આવ્યું છે.', benefitEvidence: 'પુરાવા આધારિત માર્ગદર્શન', benefitEvidenceDescription: 'તમારા દસ્તાવેજોની વિગતો પર આધારિત.', benefitCaseTracking: 'કેસ ટ્રેકિંગ', benefitCaseTrackingDescription: 'દસ્તાવેજો, પગલાં અને પ્રગતિ એક જગ્યાએ રાખો.', benefitTimeline: 'સમયરેખા દૃશ્ય', benefitTimelineDescription: 'શું થયું અને આગળ શું થશે તે જુઓ.', benefitActionPlans: 'કાર્ય યોજનાઓ', benefitActionPlansDescription: 'અનિશ્ચિતતામાંથી સ્પષ્ટ આગળના પગલા સુધી પહોંચો.' },
  pa: { benefitSimple: 'ਸੌਖੀਆਂ ਵਿਆਖਿਆਵਾਂ', benefitSimpleDescription: 'ਗੁੰਝਲਦਾਰ ਨਾਗਰਿਕ ਜਾਣਕਾਰੀ ਨੂੰ ਸੌਖੀ ਭਾਸ਼ਾ ਵਿੱਚ ਸਮਝੋ।', benefitMultilingual: 'ਬਹੁਭਾਸ਼ੀ ਸਹਾਇਤਾ', benefitMultilingualDescription: 'ਭਾਰਤ ਦੇ ਲੋਕਾਂ ਲਈ ਬਣਾਇਆ ਗਿਆ।', benefitEvidence: 'ਸਬੂਤ-ਅਧਾਰਿਤ ਮਾਰਗਦਰਸ਼ਨ', benefitEvidenceDescription: 'ਤੁਹਾਡੇ ਦਸਤਾਵੇਜ਼ਾਂ ਦੇ ਵੇਰਵਿਆਂ ਉੱਤੇ ਆਧਾਰਿਤ।', benefitCaseTracking: 'ਕੇਸ ਟਰੈਕਿੰਗ', benefitCaseTrackingDescription: 'ਦਸਤਾਵੇਜ਼, ਕਾਰਵਾਈਆਂ ਅਤੇ ਤਰੱਕੀ ਇਕੱਠੇ ਰੱਖੋ।', benefitTimeline: 'ਸਮਾਂਰੇਖਾ ਦ੍ਰਿਸ਼', benefitTimelineDescription: 'ਦੇਖੋ ਕੀ ਹੋਇਆ ਅਤੇ ਅੱਗੇ ਕੀ ਹੋਵੇਗਾ।', benefitActionPlans: 'ਕਾਰਜ ਯੋਜਨਾਵਾਂ', benefitActionPlansDescription: 'ਅਨਿਸ਼ਚਿਤਤਾ ਤੋਂ ਸਪਸ਼ਟ ਅਗਲੇ ਕਦਮ ਵੱਲ ਵਧੋ।' },
  or: { benefitSimple: 'ସରଳ ବ୍ୟାଖ୍ୟା', benefitSimpleDescription: 'ଜଟିଳ ନାଗରିକ ସୂଚନାକୁ ସରଳ ଭାଷାରେ ବୁଝନ୍ତୁ।', benefitMultilingual: 'ବହୁଭାଷୀ ସହାୟତା', benefitMultilingualDescription: 'ଭାରତର ଲୋକଙ୍କ ପାଇଁ ନିର୍ମିତ।', benefitEvidence: 'ପ୍ରମାଣ ଆଧାରିତ ମାର୍ଗଦର୍ଶନ', benefitEvidenceDescription: 'ଆପଣଙ୍କ ଦଲିଲର ବିବରଣୀ ଉପରେ ଆଧାରିତ।', benefitCaseTracking: 'ମାମଲା ଟ୍ରାକିଂ', benefitCaseTrackingDescription: 'ଦଲିଲ, ପଦକ୍ଷେପ ଓ ପ୍ରଗତିକୁ ଏକାଠି ରଖନ୍ତୁ।', benefitTimeline: 'ସମୟରେଖା ଦୃଶ୍ୟ', benefitTimelineDescription: 'କଣ ଘଟିଲା ଏବଂ ପରେ କଣ ହେବ ଦେଖନ୍ତୁ।', benefitActionPlans: 'କାର୍ଯ୍ୟ ଯୋଜନା', benefitActionPlansDescription: 'ଅନିଶ୍ଚିତତାରୁ ସ୍ପଷ୍ଟ ପରବର୍ତ୍ତୀ ପଦକ୍ଷେପକୁ ଯାଆନ୍ତୁ।' },
  as: { benefitSimple: 'সহজ ব্যাখ্যা', benefitSimpleDescription: 'জটিল নাগৰিক তথ্য সহজ ভাষাত বুজক।', benefitMultilingual: 'বহুভাষিক সহায়', benefitMultilingualDescription: 'ভাৰতৰ লোকসকলৰ বাবে নিৰ্মিত।', benefitEvidence: 'প্ৰমাণভিত্তিক নিৰ্দেশনা', benefitEvidenceDescription: 'আপোনাৰ নথিৰ বিৱৰণৰ ওপৰত আধাৰিত।', benefitCaseTracking: 'গোচৰ অনুসৰণ', benefitCaseTrackingDescription: 'নথি, পদক্ষেপ আৰু অগ্ৰগতি একেলগে ৰাখক।', benefitTimeline: 'সময়ৰেখা দৃশ্য', benefitTimelineDescription: 'কি ঘটিল আৰু পৰৱৰ্তী কি হ’ব চাওক।', benefitActionPlans: 'কাৰ্য পৰিকল্পনা', benefitActionPlansDescription: 'অনিশ্চয়তাৰ পৰা স্পষ্ট পৰৱৰ্তী পদক্ষেপলৈ আগবাঢ়ক।' },
  ur: { benefitSimple: 'آسان وضاحتیں', benefitSimpleDescription: 'پیچیدہ شہری معلومات کو آسان زبان میں سمجھیں۔', benefitMultilingual: 'کثیر لسانی معاونت', benefitMultilingualDescription: 'بھارت کے لوگوں کے لیے بنایا گیا۔', benefitEvidence: 'شواہد پر مبنی رہنمائی', benefitEvidenceDescription: 'آپ کی دستاویزات کی تفصیلات پر مبنی۔', benefitCaseTracking: 'کیس ٹریکنگ', benefitCaseTrackingDescription: 'دستاویزات، اقدامات اور پیش رفت ایک جگہ رکھیں۔', benefitTimeline: 'ٹائم لائن منظر', benefitTimelineDescription: 'دیکھیں کیا ہوا اور آگے کیا ہوگا۔', benefitActionPlans: 'عملی منصوبے', benefitActionPlansDescription: 'غیر یقینی سے واضح اگلے قدم کی طرف بڑھیں۔' },
};
...
export function useTranslations() {
  ...
  return (key: TranslationKey) => {
    const value = translations[language]?.[key]
      ?? benefitTranslations[language]?.[key]
      ?? reviewTranslations[language]?.[key]
      ?? reviewTranslations.en?.[key]
      ?? localeFallbacks[language][key]
      ?? landingLocaleCopy[language]?.[key]
      ?? navigationTranslations[language]?.[key]
      ?? translations.en?.[key];
    if (value) return value;
    if (process.env.NODE_ENV !== 'production') console.error(`[i18n] Missing translation: ${String(key)} (${language})`);
    return missingLocaleMessage[language];
  };
}
